...
parser.add_argument('--iter_num', type=int, help="Specify the number of iterations of searching.")
...
iteration_number = args.iter_num
tag = args.tag
...
if comm_rank == 0:
    ...
    with h5py.File(file_name, 'w') as h5file:
        ...
        h5file.create_dataset("iter_num", data=iteration_number, dtype=numpy.int64)
